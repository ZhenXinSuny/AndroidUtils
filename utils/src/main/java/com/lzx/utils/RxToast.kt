...
object RxToast {
    ...
    fun normal(message: String) {
        normal(UtilsApplication.getInstance().context, message, Toast.LENGTH_SHORT, null, false)?.show()
    }

    @JvmStatic
    fun normal(message: String, icon: Drawable?) {
        normal(UtilsApplication.getInstance().context, message, Toast.LENGTH_SHORT, icon, true)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int) {
        normal(UtilsApplication.getInstance().context, message, duration, null, false)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int, icon: Drawable?) {
        normal(UtilsApplication.getInstance().context, message, duration, icon, true)?.show()
    }

    @JvmStatic
    fun normal(message: String, duration: Int, icon: Drawable?, withIcon: Boolean): Toast? {
        return custom(UtilsApplication.getInstance().context, message, icon, DEFAULT_TEXT_COLOR, duration, withIcon)
    }

    @JvmStatic
    fun warning(message: String) {
        warning(UtilsApplication.getInstance().context, message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun warning(message: String, duration: Int) {
        warning(UtilsApplication.getInstance().context, message, duration, true)?.show()
    }

    @JvmStatic
    fun warning(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(UtilsApplication.getInstance().context, message, getDrawable(UtilsApplication.getInstance().context, R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true)
    }

    @JvmStatic
    fun info(message: String) {
        info(UtilsApplication.getInstance().context, message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun info(message: String, duration: Int) {
        info(UtilsApplication.getInstance().context, message, duration, true)?.show()
    }

    @JvmStatic
    fun info(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(UtilsApplication.getInstance().context, message, getDrawable(UtilsApplication.getInstance().context, R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true)
    }

    @JvmStatic
    fun success(message: String) {
        success(UtilsApplication.getInstance().context, message, Toast.LENGTH_SHORT, true)?.show()
    }

    @JvmStatic
    fun success(message: String, duration: Int) {
        success(UtilsApplication.getInstance().context, message, duration, true)?.show()
    }

    @JvmStatic
    fun success(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(UtilsApplication.getInstance().context, message, getDrawable(UtilsApplication.getInstance().context, R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true)
    }

    @JvmStatic
    fun error(message: String) {
        error(UtilsApplication.getInstance().context, message, Toast.LENGTH_SHORT, true)?.show()
    }
    ...
    fun error(message: String, duration: Int) {
        error(UtilsApplication.getInstance().context, message, duration, true)?.show()
    }

    @JvmStatic
    fun error(message: String, duration: Int, withIcon: Boolean): Toast? {
        return custom(UtilsApplication.getInstance().context, message, getDrawable(UtilsApplication.getInstance().context, R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true)
    }
    ...
    fun showToastShort(str: String?) {
        Toast.makeText(UtilsApplication.getInstance().context, str, Toast.LENGTH_SHORT).show()
    }
    ...
    fun showToastShort(resId: Int) {
        Toast.makeText(UtilsApplication.getInstance().context, UtilsApplication.getInstance().context.getString(resId), Toast.LENGTH_SHORT).show()
    }
    ...
    fun showToastLong(str: String?) {
        Toast.makeText(UtilsApplication.getInstance().context, str, Toast.LENGTH_LONG).show()
    }
    ...
    fun showToastLong(resId: Int) {
        Toast.makeText(UtilsApplication.getInstance().context, UtilsApplication.getInstance().context.getString(resId), Toast.LENGTH_LONG).show()
    }
    ...
    fun showToast(msg: String?) {
        if (mToast == null) {
            mToast = Toast.makeText(UtilsApplication.getInstance().context, msg, Toast.LENGTH_LONG)
        } else {
            mToast?.setText(msg)
        }
        mToast?.show()
    ...
    fun showToast(resId: Int) {
        if (mToast == null) {
            mToast = Toast.makeText(UtilsApplication.getInstance().context, UtilsApplication.getInstance().context.getString(resId), Toast.LENGTH_LONG)
        } else {
            mToast?.setText(UtilsApplication.getInstance().context.getString(resId))
        }
        mToast?.show()
    }
